        ...
        children: [
          ...
          Expanded(
            child: Obx(() {
              ...
              } else if(ParentController.data.state.addressHistory.isNotEmpty) {
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      ListView.builder(
                        itemCount: ParentController.data.state.addressHistory.length,
                        shrinkWrap: true,
                        physics: NeverScrollableScrollPhysics(),
                        itemBuilder: (context, index) {
                          Address address = ParentController.data.state.addressHistory[index];
