...
class ResultController extends GetxController {
  ...
  void onInit() {
    if(args != null && args is Map<String, dynamic>) {
      ...
      ParentController.data.updateRecentAddresses(state.search.value.pickup);
    }
  ...
  void sortByOpen() {
    List<SearchShopResponse> shops = state.shops;
    state.sortedShops.value = shops.where((shop) => shop.shop.open).toList();
  ...
  void sortByRating() {
    state.sortedShops.value = state.shops;
    state.sortedShops.sort((a, b) => b.shop.rating.compareTo(a.shop.rating));
  }
}