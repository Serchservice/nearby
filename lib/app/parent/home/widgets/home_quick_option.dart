...
class HomeQuickOption extends StatelessWidget {
  final CategorySection section;
  final Function(CategorySection) onClicked;

  const HomeQuickOption({super.key, required this.section, required this.onClicked});
