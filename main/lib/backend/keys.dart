...
class Keys {
  /// Serch api key
  static final String _apiKey = "API_KEY";
  static final String apiKey = PlatformEngine.instance.isWeb
      ? String.fromEnvironment(_apiKey)
      : dotenv.env[_apiKey] ?? "";

  /// Serch secret key
  static final String _secretKey = "SECRET_KEY";
  static final String secretKey = PlatformEngine.instance.isWeb
      ? String.fromEnvironment(_secretKey)
      : dotenv.env[_secretKey] ?? "";

  /// Serch signature
  static final String _signature = "SIGNATURE";
  static final String signature = PlatformEngine.instance.isWeb
      ? String.fromEnvironment(_signature)
