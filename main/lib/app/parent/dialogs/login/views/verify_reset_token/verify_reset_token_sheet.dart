...
class VerifyResetTokenSheet extends StatelessWidget {
  final String emailAddress;
  const VerifyResetTokenSheet({super.key, required this.emailAddress});

  static void open(String emailAddress) {
    Navigate.bottomSheet(
      sheet: VerifyResetTokenSheet(emailAddress: emailAddress),
      route: Navigate.appendRoute("/auth/forgot_password/verify"),
      isScrollable: true
    );
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            BannerAdLayout(
              expandChild: false,
              child: GetBuilder<VerifyResetTokenController>(
                init: VerifyResetTokenController(emailAddress),
                builder: (controller) {
                  return Column(
                    spacing: 10,
                    crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            return TextButton(
                              ...
                              style: ButtonStyle(
                                overlayColor: WidgetStateProperty.resolveWith((states) {
                                  return CommonColors.instance.darkTheme2.lighten(68);
                                }),
