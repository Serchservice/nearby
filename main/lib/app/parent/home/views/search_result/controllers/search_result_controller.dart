...
class ResultController extends GetxController {
  ...
  void onInit() {
    if(args != null && args is Map<String, dynamic>) {
      ...
      HistoryController.data.updateRecentAddresses(state.search.value.pickup);
    }
  ...
  void _sortByOpen() {
    ...
    shops = shops.where((shop) => shop.shop.open).toList();
  ...
  void _sortByRating() {
    List<SearchShopResponse> shops = List.from(state.shops);
    shops.sort((a, b) => b.shop.rating.compareTo(a.shop.rating));
